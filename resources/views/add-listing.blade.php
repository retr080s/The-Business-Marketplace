...
<div class="m-8">
    <form method="POST" action='/add-listing' class="max-w-md mx-auto">
        ...
        <div class="invisible">
            <input type="text" name="company" id="company" value="{{ $user->name }}" tabindex="0" />
        </div>
